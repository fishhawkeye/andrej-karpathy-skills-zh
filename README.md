...
```
/plugin marketplace add https://github.com/fishhawkeye/andrej-karpathy-skills-zh
```

然后安装插件：
```
/plugin install andrej-karpathy-skills-zh@karpathy-skills
```
...
新项目：
```bash
curl -o CLAUDE.md https://raw.githubusercontent.com/hawkeye/andrej-karpathy-skills-zh/main/CLAUDE.md
```

已有项目（追加）：
```bash
echo "" >> CLAUDE.md
curl https://raw.githubusercontent.com/hawkeye/andrej-karpathy-skills-zh/main/CLAUDE.md >> CLAUDE.md
```
